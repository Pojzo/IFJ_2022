...
typedef enum {STATE_START, 
	STATE_ID_START, STATE_ID_MAIN, STATE_ID,
       	...
       	STATE_SEP, STATE_QUESTION_INT, STATE_QUESTION_FLOAT, STATE_QUESTION_STRING, STATE_QUESTION_VOID,
...
STATE_EQUAL_1, STATE_EQUAL_2, STATE_GREATER_EQUAL, STATE_SMALLER_EQUAL, STATE_NOT_1, STATE_NOT_2, STATE_LIT_NUM_FLOAT, STATE_LIT_NUM_FLOAT_2, STATE_LIT_NUM_FLOAT_E, STATE_LIT_NUM_FLOAT_E_2, STATE_LIT_NUM_FLOAT_E_3, STATE_TERMINATE} state;
